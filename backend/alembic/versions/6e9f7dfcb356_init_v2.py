...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['course_id', 'course_semester'], ['courses.id', 'courses.semester'], ),
    ...
    sa.Column('course_id', sa.String(), nullable=False),
    sa.Column('course_semester', sa.String(), nullable=False),
    sa.Column('role', sa.Enum('lecturer', 'teaching assistant', 'student', name='enrollment_roles'), nullable=True),
    sa.ForeignKeyConstraint(['course_id', 'course_semester'], ['courses.id', 'courses.semester'], ),
